<template>
    ...
    >
        ...
        <div class="entry-description">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Doloribus, facere obcaecati iste delectus laudantium vel est, necessitatibus, nobis dolor nostrum corrupti deleniti eveniet! Voluptatibus doloremque officia adipisci natus beatae placeat?
        </div>
    </div>
</template>
